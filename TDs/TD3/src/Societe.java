    ...
    public Societe(int n) {
        ...
        for (int i = 0; i < n; i++) {
            switch ((int) (Math.random() * 5)) {
                case 0:
                    societe[i] = new Noble("Personne_" + i);
                    break;
                case 1:
                    societe[i] = new Bourgeois("Personne_" + i);
                    break;
                case 2:
                    societe[i] = new Paysan("Personne_" + i);
                    break;
                case 3:
                    societe[i] = new Artisans("Personne_" + i);
                    break;
                case 4:
                    societe[i] = new Pretre("Personne_" + i);
                    break;
            }
        }
    }

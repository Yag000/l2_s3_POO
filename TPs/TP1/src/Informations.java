public class Informations {
    ...
    // On considere que la vitalité est toujours superieur ou egale a 0(ce qui
    // signifie la por du personnage)
    public void setVitalite(int v) {
        this.vitalite = Math.max(0, v);
    }
    ...
    public String toString() {
        return this.vitalite + "/" + this.force + "/" + this.agilite;
    }

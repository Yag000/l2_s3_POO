    ...
    public static void main(String[] args) {
        ...
        */
        ...
        while (joueur.veutJouer()) {
            int[] dimesions = joueur.demanderDimensions();
            int mines = joueur.demanderMines();
            Plateau plateau = new Plateau(dimesions[0], dimesions[1], mines);
            Jeu jeu = new Jeu(joueur, plateau);
            System.out.println();
            if (jeu.jouer()) System.out.println("Bravo, vous avez gagne!");
            else System.out.println("BOOOOOOM, vous avez releve une bombe");
        }
        joueur.finir();
